        ...
        <div className="text-sm text-gray-800 leading-relaxed">
            ...
            <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                        <strong>기획:</strong> 서비스 흐름 설계 및 기능 명세 작성
                    </li>
                    <li>
                        <strong>디자인:</strong> Figma 시안을 바탕으로 UI/UX 가이드 수립
                    </li>
                    <li>
                        <strong>퍼블리싱:</strong> styled-components 및 React.js로 화면 레이아웃 구현
                    </li>
                    <li>
                        <strong>공통 파일 정리:</strong> `common` 디렉토리에 재사용 컴포넌트·유틸 파일 구성
                    </li>
                    <li>
                        <strong>theme.js 컴포넌트화:</strong> 전역 테마 설정을 `theme.js`로 모듈화하고 컴포넌트화 작업
                    </li>
                </ul>
            </div>
            ...
            <div className="mb-6">
                ...
                <strong>문제: </strong><span>코드 스타일 및 네이밍 컨벤션 불일치</span><br/>
                <strong>원인:</strong>
