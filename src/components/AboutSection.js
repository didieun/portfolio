    ...
    return (
        ...
        >
            <div className="max-w-[1024px] w-full text-left mx-auto">
                <motion.h2
                    className="text-3xl font-bold text-center pb-[80px]"
                ...
                <div className="flex flex-col md:flex-row items-center gap-10">
                    ...
                    >
                        ...
                        />
                        <a
                            href="/박지은-이력서.pdf" // public 폴더에 이력서 PDF 업로드할 것!
                            download
                            className="bg-[#23486A] hover:bg-[#23486A] text-white px-4 py-2 rounded-md text-sm transition"
                        >
                            이력서 다운로드
                        </a>
                    </motion.div>
                    ...
                    <div className="flex-1">
                        <motion.h2
                            className="text-4xl leading-normal font-bold mb-4"
                            initial={{ opacity: 0, x: -20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        <motion.p
                            className="text-md font-medium leading-relaxed mb-6"
                            initial={{ opacity: 0 }}
